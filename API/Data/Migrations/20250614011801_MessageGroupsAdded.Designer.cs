...
namespace API.Data.Migrations
{
    ...
    [Migration("20250614011801_MessageGroupsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.DataEntities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("API.DataEntities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("API.DataEntities.UserLike", b =>
                {
            ...
            modelBuilder.Entity("API.DataEntities.AppUserRole", b =>
                {
                    b.HasOne("API.DataEntities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.DataEntities.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("API.DataEntities.UserLike", b =>
                {
                    b.HasOne("API.DataEntities.AppUser", "SourceUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.DataEntities.AppUser", "TargetUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("API.DataEntities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("API.DataEntities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
